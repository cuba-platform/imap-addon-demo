package com.haulmont.components.samples.imap;
...
public class ImapsampleTestContainer extends TestContainer {

    public ImapsampleTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/components/samples/imap/app.properties",
    ...
    public static class Common extends ImapsampleTestContainer {

        public static final ImapsampleTestContainer.Common INSTANCE = new ImapsampleTestContainer.Common();
